...
const groupSaboresGigante: OptionGroup = { title: 'Escolha até 4 Sabores (Gigante)', items: saboresPizza, type: 'checkbox', required: true, min: 1, max: 4 };
...
export const productOptions: ProductOptionsMap = {
    ...
    // Combo Gigante + Sobremesa (4 sabores)
    'combo-pizza-vip-gigante-sobremesa': [groupBorda, groupSaboresGigante, groupBebidas],

    // Combo Broto + Gigante (1 sabor + 4 sabores) - Fluxo especial com 2 pizzas
    'promo-broto-gigante': [
        { title: 'Borda da Pizza Broto', items: bordas, type: 'radio', required: true, min: 1, max: 1 },
        { title: 'Sabor da Pizza Broto', items: saboresPizza, type: 'radio', required: true, min: 1, max: 1 },
        { title: 'Borda da Pizza Gigante', items: bordas, type: 'radio', required: true, min: 1, max: 1 },
        { title: 'Sabores da Pizza Gigante (até 4)', items: saboresPizza, type: 'checkbox', required: true, min: 1, max: 4 },
        groupBebidas
    ],

    // Combo Média + Açaí (2 sabores)
    'combo-vip-pizza-acai': [groupBorda, groupSaboresMedia, groupBebidas],

    // Pizza Gigante + Coca (4 sabores)
    'pizza-gigante-coca': [groupBorda, groupSaboresGigante, groupBebidas],

    // Pizza Gigante + Kuat (4 sabores)
    'pizza-gigante-kuat': [groupBorda, groupSaboresGigante, groupBebidas],

    // Pizza Grande + Kuat (3 sabores)
    'pizza-grande-kuat': [groupBorda, groupSaboresGrande, groupBebidas],

    // Pizza Família + Borda + Coca (4 sabores)
